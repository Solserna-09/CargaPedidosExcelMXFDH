...
Característica: Carga Pedido Excel MEXFDHC 6
  ...
  Esquema del escenario: Carga Pedido Excel MEXFDHC
    ...
    Y cargue los archivos correspondientes al MEXFDHC6 <escenario>
    ...
    Ejemplos:
      | url                                                                    | correo                     | clave  | destinatario | escenario | Productos para cancelar |
        ##@externaldata@./Datos/Excel/DataElite.xlsx@MXFDHC6
|"https://mx.cwgpxw02kj-empresasc1-s1-public.model-t.cc.commerce.ondemand.com/compraonline/login"|"102806s-g-@ecommerce.com.mx"|"cmpc2022"|"248972"|"6"|"0"|
